...
<div class="container">
    ...
    <form class="form-signin" action="${pageContext.request.contextPath}/User/login" method="post">
        ...
        <input class="btn btn-lg btn-primary" type="submit" id="signin" value="Sign in"/>
       <!--  <button class="btn btn-lg btn-primary" type="submit" id="signin">Sign in</button> -->
        <button class="btn btn-lg btn-primary" type="button" id="register" onclick="javascrtpt:window.location.href='${pageContext.request.contextPath}/jump/UserRegister'">Register</button>
    </form>
    <h3>I'm  company, click <a href="${pageContext.request.contextPath}/jump/CompanyLogin">here</a> to login</h3>
</div> <!-- /container -->
